...
export class Backend implements backendInterface {
    ...
    async adjustProductStock(arg0: ProductId, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.adjustProductStock(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createQuote(arg0: CustomerId, arg1: Array<QuoteLineItem>): Promise<Quote> {
        if (this.processError) {
            try {
    ...
    async getQuote(arg0: QuoteId): Promise<Quote> {
        if (this.processError) {
            try {
    ...
    async listQuotesByCustomer(arg0: CustomerId): Promise<Array<Quote>> {
        if (this.processError) {
            try {
                const result = await this.actor.listQuotesByCustomer(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
